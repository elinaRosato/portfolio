...
const ListWebApp = (props: Props) => {
  ...
  return (
    <div className={`${sans.variable} ${roboto.variable} ${handwritten.variable} min-h-screen overflow-scroll bg-almost-white flex flex-col`}>
      ...
      <main className=' lg:mx-[1.5vw] lg:border-2 lg:border-x-darkest-dark overflow-hidden flex'>
        <div className='flex flex-col '>
          <div className='flex w-[30vw]'>
            <Image src={listWebAppMockupDesktopDark} layout='responsive' objectFit='contain' alt='Elina Rosato' />
          </div>
          <div className='flex w-[30vw]'>
            <Image src={listWebAppMockupDesktopLight} layout='responsive' objectFit='contain' alt='Elina Rosato' />
          </div>
          <div className='flex w-[30vw]'>
            <Image src={listWebAppMockupMobileDark} layout='responsive' objectFit='contain' alt='Elina Rosato' />
          </div>
          <div className='flex w-[30vw]'>
            <Image src={listWebAppMockupMobileLight} layout='responsive' objectFit='contain' alt='Elina Rosato' />
          </div>
          <div className='flex w-[30vw]'>
            <Image src={listWebAppMockupDesktopDark} layout='responsive' objectFit='contain' alt='Elina Rosato' />
          </div>
        ...
        <div className='flex flex-col gap-[1vh] lg:gap-[1vh] py-[10vh] px-[10vw] lg:px-[10vw] lg:py-[4vw]'>
