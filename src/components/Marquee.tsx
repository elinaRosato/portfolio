  ...
  return (
    <div className='flex overflow-hidden w-screen'>
      <motion.ul ref={marqueeRef} variants={marqueeVariants}  animate='animate' className=' flex justify-around flex-shrink-0 min-w-full gap-40 px-20'>
        <AnimatedTitle text="frontend" className='text-[20vw] leading-[20vw] lg:text-[11vw] lg:leading-[12vw] text-transparent font-sans font-bold xl:font-bold text-stroke overflow-hidden flex' />
        <AnimatedTitle text="frontend" className='text-[20vw] leading-[20vw] lg:text-[11vw] lg:leading-[12vw] text-transparent font-sans font-bold xl:font-bold text-stroke overflow-hidden flex' />
      </motion.ul>
      <motion.ul variants={marqueeVariants}  animate='animate' className='flex justify-around flex-shrink-0 min-w-full gap-40 px-20' aria-hidden="true">
        <li className='text-[20vw] leading-[20vw] lg:text-[11vw] lg:leading-[12vw] text-transparent font-sans xl:font-bold font-bold text-stroke'>frontend</li>
        <li className='text-[20vw] leading-[20vw] lg:text-[11vw] lg:leading-[12vw] text-transparent font-sans font-bold xl:font-bold text-stroke'>frontend</li>
      </motion.ul>
    </div>
  )
}
